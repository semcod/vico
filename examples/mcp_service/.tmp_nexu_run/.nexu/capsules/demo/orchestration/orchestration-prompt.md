...
capsule:
  name: demo
  type: vertical_slice
  source_project_root: /home/tom/github/semcod/nexu/examples/mcp_service/.tmp_nexu_run
  ...
  - S2
  baseline_files:
    src/demo.py: 3d802fe15b31ab3371c60c85f5140fd308490d8bf918005e4a1b10e064b1c56e
goal: demo
steps: 3
contracts:
...
verification:
  ...
  - code: output_presence
    status: pass
    message: Declared outputs have text evidence in capsule sources.
    evidence:
    - 'evidence_map: src/src/demo.py'
    - 'evolved_capsule: src/src/demo.py'
    - 'promotion_plan: src/src/demo.py'
